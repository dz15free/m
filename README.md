...
- [~] Phase 10 — دفاتر الأستاذ (وفق المنظومة الجزائرية): الدفتر اليومي من جدول التوقيت + دفتر التكوين والندوات، طباعة رسمية A4 برأس تلقائي. التالي: دفتر التحضير (المذكرات) والتوزيعات، ثم دفتر التنقيط مع التقييم
