...
- [~] Phase 10 — دفاتر الأستاذ وفق النموذج الجزائري للابتدائي: الدفتر اليومي (فترة صباحية/مسائية، المدة، النشاط، الميدان، المحتوى، مركبات الكفاءة، التاريخ الهجري)، دفتر التكوين والندوات (الندوات الشهرية، الأيام الدراسية، التربصات، خلاصات حسب مجالات التكوين)، دفتر التحضير (مذكرات بمراحلها الثلاث، نسخ وإعادة استعمال، ملء الدفتر اليومي من مذكرة). التالي: دفتر التنقيط مع التقويم
- [ ] Phase 11–16 — انظر `docs/ARCHITECTURE.md` §39
